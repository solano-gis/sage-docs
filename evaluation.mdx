...
<AccordionGroup>
  <Accordion title="Accuracy (6 goals)">
    ...
    | Polygon spatial filter | Parcel count within a FEMA flood zone using polygon geometry | Uses `geometry_from` for polygon-precision spatial query |
  </Accordion>
...
```json
{
  ...
  "summary": {
    ...
    "avgDurationMs": 28400,
    "byCategory": {
      "accuracy":   { "total": 6, "passed": 6, "rate": 1.0, "criteriaRate": 1.0 },
