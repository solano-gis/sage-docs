...
| **References** | Deep-dive files (field semantics, regulatory detail) | Bundled in SKILL.md or via `get_layer_context` | 500–5,000 per file |

A typical specialized query loads 1 skill = 1,000–3,000 tokens of domain knowledge.
