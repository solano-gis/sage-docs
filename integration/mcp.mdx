...
SAGE uses the [Model Context Protocol (MCP)](https://modelcontextprotocol.io/) for communication between sage-web and its two data servers. MCP is an open standard for connecting AI models to external tools and data sources.
...
This means sage-gis and sage-gov can be consumed by other AI systems, custom scripts, or future applications — independent of sage-web.
